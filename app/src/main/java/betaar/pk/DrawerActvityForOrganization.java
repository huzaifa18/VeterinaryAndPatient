...
public class DrawerActvityForOrganization extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drawer_actvity_for_organization);
        ...
        mNavigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                if (menuItem.getItemId() == R.id.nav_item_home) {
                    //home activity
                    showDialogue();
                    /*startActivity(new Intent(DrawerActvityForOrganization.this, ProfileUpdateForVeterinary.class));*/
                ...
                if (menuItem.getItemId() == R.id.nav_item_my_orders) {
                    ...
                    showDialogue();
                    /*Intent i = new Intent(DrawerActvityForOrganization.this, History.class);
                    i.putExtra("Type","Organization");
                    startActivity(i);*/
                ...
                if (menuItem.getItemId() == R.id.nav_item_help){
                    ...
                    //startActivity(new Intent(DrawerActvityForOrganization.this, Help.class));
                    //showDialogue();
                ...
                if (menuItem.getItemId() == R.id.nav_item_about){
                    ...
                    Intent i = new Intent(DrawerActvityForOrganization.this, AboutUs.class);
                    startActivity(i);
                ...
                if (menuItem.getItemId() == R.id.nav_item_contact_us){
                    ...
                    Intent i = new Intent(DrawerActvityForOrganization.this, ContactUs.class);
                    startActivity(i);
                }
    ...
    private void showDialogue(){
        ...
        final Dialog dialog = new Dialog(DrawerActvityForOrganization.this);
        ...
        bt_proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                /*Intent i = new Intent(DrawerActvityForOrganization.this, DashBoardOrganization.class);
