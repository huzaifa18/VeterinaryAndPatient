...
import betaar.pk.EquineSolution;
import betaar.pk.R;
...
public class FregamentEquin extends Fragment {
    ...
    private void init(View view){
        ...
        /*ArrayAdapter adapter = ArrayAdapter.createFromResource(getActivity(),
                R.array.equine_categories, R.layout.spinner_dropdown_item);

        //adapter.setDropDownViewResource(R.layout.spinner_dropdown_item);
        sp_select_equin.setAdapter(adapter);*/

        SpinnerListingAdapter category = new SpinnerListingAdapter(getContext(), Arrays.equine_categories);
        sp_select_equin.setAdapter(category);
    ...
    private void callingVeterinaryActivity(){
        ...
        bt_call_a_veteriany.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (sp_select_equin.getSelectedItemPosition() == 0){

                    Toast.makeText(getContext(), "Please Select Equin Category", Toast.LENGTH_SHORT).show();
                    ...
                    callVet.putExtra("category_id", Arrays.getID(Arrays.product_types, "Equine Solution"));
                    callVet.putExtra("sub_category_id", Arrays.equine_categories.get(sp_select_equin.getSelectedItemPosition()).getId());
                    Log.e("TAG", "Sub Category1: " + Arrays.equine_categories.get(sp_select_equin.getSelectedItemPosition()).getId());
    ...
    private void farmSolutionActivity(){
        ...
        bt_farm_solutino.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                farmSolution.putExtra("category_id", Arrays.getID(Arrays.product_types,"Equine Solution"));
        ...
        bt_sale_equine.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Animation animShake = AnimationUtils.loadAnimation(getActivity(), R.anim.shake);
                    ...
                    i.putExtra("category_id", Arrays.getID(Arrays.product_types,"Equine Solution"));
                    startActivity(i);
